...
var vForgetPwd = new Vue({
	...
	data: function() {
		return {
			...
			msgCode: '',
			picCode: '', //绑定属性
			imgSrc: METHOD_URL + firstPath + '/forgetPwdCode/findVerifyCode.sose',
			loginNameFindErr: '',
...
function refreshForget() {
	var url = METHOD_URL + firstPath + "/forgetPwdCode/findVerifyCode.sose?number=" + Math.random();
