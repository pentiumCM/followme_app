...
var loginPath = '../account/login.html'
var vRegister = new Vue({
	...
	data: function() {
		return {
			...
			emailCode: '',
			picCode: '', //绑定属性
			imgSrc: METHOD_URL + firstPath + '/registerCode/findVerifyCode.sose',
			loginNameFindErr: '',
 ...
 */
function checkPhone() {
	var result = VERIFY_PHONE.test(vRegister.phone);
 ...
 */
function checkEmail() {
	var result = VERIFY_EMAIL.test(vRegister.email);
...
function comparePicCode() {
	...
	//调动业务端方法
	var url = firstPath + '/registerCode/comparePicCode';
...
function compareSmsCode() {
	...
	//调动业务端方法
	var url = firstPath + '/registerPhone/compareSmsCode';
...
function compareEmailCode() {
	//设置参数
	var data = {
		emailCode: vRegister.emailCode
	};
	//调动业务端方法
	var url = firstPath + '/registerEmail/compareEmailCode';
...
function register() {
	...
	//调动业务端方法
	var url = firstPath + '/accountRegister';
...
function registerSuc(data) {
	...
	if(data.info == "phoneError") {
		vRegister.phoneErr = '请填写获取短信的手机号码！';
		return;
	}
	if(data.info == "emailError") {
...
function sendMessage() {
	...
	//调动业务端方法
	var url = firstPath + "/registerPhone/sendMessage";
...
function sendEmail() {
	...
	//调动业务端方法
	var url = firstPath + "/registerEmail/sendEmail";
...
function refreshRegister() {
	var url = METHOD_URL + firstPath + "/registerCode/findVerifyCode.sose?number=" + Math.random();
